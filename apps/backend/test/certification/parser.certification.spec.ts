...
import { HeaderDetectionScanner } from '../../src/statements/parsers/header-detection.scanner';
import { FinancialInvariantEngine } from '../../src/common/invariants/financial-invariant.engine';
            ...
            const corruptSalaryTxn: CanonicalTransaction[] = [
                {
                    ...
                    date: new Date('2026-04-07'),
                    amount: 500000,
                    type: 'CREDIT', // Financially impossible: Salary as Credit
                    category: 'Revenue',
